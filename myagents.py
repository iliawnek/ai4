...
class StateSpace(object):
    """ This is a data type used to collect a number of important aspects of the environment
    It can be built online or be created offline using the Helper Agent
    ...
    xml_str = '''<?xml version="1.0" encoding="UTF-8" ?>
        <Mission xmlns="http://ProjectMalmo.microsoft.com" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
          ...
          <ServerSection>
            ...
            <ServerHandlers>
              <FlatWorldGenerator generatorString="37,220*1,5*3,23,biome_1" />
              <MazeDecorator>
...
# ----------------------------------------------------------------------------------------------------------------#
# This function initialises the mission based on the input arguments
...
if __name__ == "__main__":
    ...
    DEFAULT_MALMO_PATH = 'C:/Users/Bjorn/Dropbox/ug/ai2016/malmo/Malmo-0.17.0-Windows-64bit/'  # HINT: Change this to your own path, forward slash only!
    DEFAULT_AIMA_PATH = 'C:/Users/Bjorn/Dropbox/ug/ai2016/AI2016-2017_bj/code/aima-python/'  # HINT: Change this to your own path, forward slash only, should be the 2.7 version from https://www.dropbox.com/s/vulnv2pkbv8q92u/aima-python_python_v27_r001.zip?dl=0)
